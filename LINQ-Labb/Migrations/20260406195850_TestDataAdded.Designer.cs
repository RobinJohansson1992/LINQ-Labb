...
namespace LINQ_Labb.Migrations
{
    ...
    [Migration("20260406195850_TestDataAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LINQ_Labb.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LINQ_Labb.Models.Customer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LINQ_Labb.Models.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = 4,
                            CustomerId = 4,
                            OrderDate = new DateTime(2026, 3, 12, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Status = "Levererad",
                            TotalAmount = 3499m
                        },
                        new
                        ...
                        new
                        {
                            Id = 6,
                            CustomerId = 1,
                            OrderDate = new DateTime(2026, 2, 20, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Status = "Levererad",
                            TotalAmount = 899m
                        },
                        new
                        {
                            Id = 7,
                            CustomerId = 3,
                            OrderDate = new DateTime(2026, 2, 25, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Status = "Levererad",
                            TotalAmount = 2546m
                        },
                        new
                        {
                            Id = 8,
                            CustomerId = 2,
                            OrderDate = new DateTime(2026, 3, 18, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Status = "Skickad",
                            TotalAmount = 3496m
                        },
                        new
            ...
            modelBuilder.Entity("LINQ_Labb.Models.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LINQ_Labb.Models.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LINQ_Labb.Models.Supplier", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LINQ_Labb.Models.Order", b =>
                {
                    b.HasOne("LINQ_Labb.Models.Customer", "Customer")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("LINQ_Labb.Models.OrderDetail", b =>
                {
                    b.HasOne("LINQ_Labb.Models.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LINQ_Labb.Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("LINQ_Labb.Models.Product", b =>
                {
                    b.HasOne("LINQ_Labb.Models.Category", "Category")
                        .WithMany("Products")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LINQ_Labb.Models.Supplier", "Supplier")
                        .WithMany("Products")
